      ...
      <div className="flex-1 min-w-0 flex flex-col overflow-auto">
        <header className="lg:hidden sticky top-0 z-40 flex items-center gap-3 bg-white border-b border-gray-200 px-4 h-14 shadow-sm">
          ...
          <div className="flex items-center gap-2 flex-1">
            <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-[#1A56A0] to-[#2D6CC0] flex items-center justify-center text-white font-black text-xs">E</div>
            <span className="font-bold text-[#0C2B60] text-sm">Emotiva</span>
            <span className="text-gray-300 mx-1">·</span>
            <span className="text-xs text-gray-500">Psicólogo/a</span>
          </div>
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#1A56A0] to-[#2D6CC0] flex items-center justify-center text-white font-bold text-xs">CT</div>
        </header>
